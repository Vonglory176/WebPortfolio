...
const ProjectCard = ({project, index}) => {
    ...
    return (
        <div key={index} className='project-card bg-gray-800 rounded-lg overflow-hidden relative w-full h-full max-w-[384px] max-h-[216px] shadow-lg'> {/* w-[343px] h-[195px] */}
            ...
            <div className='project-card-info flex flex-col items-center justify-between text-center gap-2 py-4 absolute bottom-0 bg-black bg-opacity-50 w-full h-full'>
