...
const About = () => {
  return (
    <SectionWrapper id='about' title='About'>
        <div className='flex flex-1 flex-col px-4 py-8 items-center justify-center gap-4 bg-gray-800 bg-opacity-30 relative'> {/* flex-1 h-full  */}

            <div className="content-wrapper max-w-[548px] mx-auto"> {/* 619px */}

                <div className="flex flex-col items-center gap-4 px-4 py-6 rounded-lg bg-gray-800 z-10 sha">
                    ...
                    <h3 className='text-center text-2xl font-bold w-full'>Meet Skyler</h3>
                    <p>Results-oriented and highly motivated <span className='text-blue-500'>Full-Stack Developer</span> with <span className='text-blue-500'>3+ years</span> of experience in <span className='text-blue-500'>Web Development</span>, specializing in the <span className='text-blue-500'>MERN tech stack</span>.</p>
                    <p>Proficient in <span className='text-blue-500'>Responsive Design</span>, <span className='text-blue-500'>Best Practices</span>, and <span className='text-blue-500'>W3C Standards</span>. <span className='text-blue-500'>Self-motivated</span>, <span className='text-blue-500'>fast learner</span>, and always eager to tackle new challenges to expand my skillset.</p>

                    <button className='bg-blue-700 px-4 py-2 mt-2 rounded hover:bg-blue-800'>Download Resume</button>
                </div>

                <div className="flex justify-around w-full p-4 z-10">
